    ...
    <section class="principal-2">
        <div class="involucro">
            <div class="col-esquerda">
                <div class="nomeuser">
                    <?php
                    echo "<h1>Olá, {$_SESSION['usuario_logado']}!</h1> <br>";
                    ?>
                </div>
        ...
        <div class="involucro">
            <div class="col-direita">
                ...
                <div class="perfil-ficha">
                    ...
                    <div class="nomeuser">
                        <p class="nomeUsuario">Patrícia_Souza&emsp;&emsp;&emsp;</p>
                ...
                <div class="perfil-ficha">
                    ...
                    <div class="nomeuser">
                        <p class="nomeUsuario">Maikel_Morales&emsp;</p>
                        <p class="sub-texto">Segue você</p>
                    </div>
                    <button class="acao-btn">&emsp;&emsp;Seguir</button>
                </div>
                <div class="perfil-ficha">
                    <div class="perfil-pic">
                    ...
                    <div class="nomeuser">
                        <p class="nomeUsuario">Savana_Kurupan&emsp;</p>
                        <p class="sub-texto">Segue você</p>
                    </div>
                    <button class="acao-btn">&emsp;Seguir</button>
                </div>
                <div class="perfil-ficha">
                    <div class="perfil-pic">
